...
namespace Hardlight.SDK.Experimental
{
	public class TrackingTest : MonoBehaviour
	{
		...
		//These offsets are based on the physical hardware. I believe the L/R arm will need a 180 degree flip in one of these dimensions
		//The VR Mimic project which features upper body tracking examples accounted for this elsewhere.
		//[Header("Use Offset")]
		[Header("0, 0, 0 for L/R Arm")]
		[Header("0, 15, 270 for Chest")]
		public Vector3 preChiralOffset = Vector3.zero;

		[Header("-270, 0, 90 for L/R Arm")]
		[Header("-270, 0, 180 for Chest")]
		public Vector3 Offset = new Vector3(-270, 0, 90);

		private float BaseZOffsetAmount = 90;
		[Header("The Playspace Heading Direction")]
		[SerializeField]
