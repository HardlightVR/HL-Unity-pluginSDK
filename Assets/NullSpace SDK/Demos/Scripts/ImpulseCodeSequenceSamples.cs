...
namespace NullSpace.SDK.Demos
{
	public class ImpulseHapticSequenceSamples : MonoBehaviour
	{
		public static HapticSequence ClickHum()
		{
			...
			HapticEffect eff = new HapticEffect(Effect.Click, 0.0f, 1.0f);
			seq.AddEffect(0, eff);
			eff = new HapticEffect(Effect.Hum, .2f, .5f);
		...
		{
			HapticSequence seq = new HapticSequence();
			HapticEffect eff = new HapticEffect(Effect.Click, 0.15f, 1.0f);
			seq.AddEffect(0, eff);
			eff = new HapticEffect(Effect.Fuzz, .2f, 1.0f);
			seq.AddEffect(.15, eff);
			return seq;
		}
		...
		public static HapticSequence ClickStorm()
		{
			...
			HapticEffect eff = new HapticEffect(Effect.Double_Click, .0f, 1.0f);
			seq.AddEffect(0, eff);

			eff = new HapticEffect(Effect.Click, .0f, 1.0f);
			seq.AddEffect(0.1, eff);

			eff = new HapticEffect(Effect.Click, .0f, 1.0f);
			seq.AddEffect(0.2, eff);

			eff = new HapticEffect(Effect.Double_Click, .0f, 1.0f);
			seq.AddEffect(0.3, eff);

			eff = new HapticEffect(Effect.Triple_Click, .0f, 1.0f);
		...
		{
			HapticSequence seq = new HapticSequence();
			HapticEffect eff = new HapticEffect(Effect.Double_Click, 0.00f, 1.0f);

			seq.AddEffect(0, eff);
			eff = new HapticEffect(Effect.Buzz, .05f, 1.0f);
			seq.AddEffect(.05, eff);
			eff = new HapticEffect(Effect.Buzz, .10f, .6f);
			seq.AddEffect(.10, eff);
			eff = new HapticEffect(Effect.Buzz, .15f, .2f);
			seq.AddEffect(.2, eff);
		...
		//	seq.AddEffect(0, eff);
			...
			seq.AddEffect(.05, eff);
			eff = new HapticEffect(Effect.Hum, .1f, .1f);
			seq.AddEffect(.15, eff);
			eff = new HapticEffect(Effect.Hum, .1f, .5f);
		...
		public static HapticSequence PulseBumpPulse()
		{
			...
			HapticEffect eff = new HapticEffect(Effect.Pulse, 0.40f, 0.7f);
			seq.AddEffect(0.0, eff);

			eff = new HapticEffect(Effect.Bump, .0f, 1.0f);
			seq.AddEffect(0.40, eff);

			eff = new HapticEffect(Effect.Pulse, 0.0f, 0.2f);
		...
		public static HapticSequence TripleClickFuzzFalloff()
		{
			...
			HapticEffect eff = new HapticEffect(Effect.Triple_Click, 0.20f, 0.7f);
			seq.AddEffect(0.0, eff);

			eff = new HapticEffect(Effect.Fuzz, .20f, 1.0f);
			seq.AddEffect(0.2, eff);

			eff = new HapticEffect(Effect.Fuzz, .20f, 0.5f);
			seq.AddEffect(0.4, eff);
		...
		public static HapticSequence RandomPulses(int randSeed)
		{
			...
			HapticEffect eff = new HapticEffect(Effect.Pulse, dur, ((float)rand.Next(0, 10)) / 10);
			seq.AddEffect(0.0, eff);
			float offset = dur;
			...
			//Debug.Log(dur + "\n");
			eff = new HapticEffect(Effect.Pulse, dur, ((float)rand.Next(0, 10)) / 10);
		...
		public static HapticSequence ThreeRandomEffects(int randSeed)
		{
			...
			HapticEffect eff = new HapticEffect(SuitImpulseDemo.effectOptions[effIndex], 0.0f, ((float)rand.Next(2, 10)) / 10);
			seq.AddEffect(0.0, eff);

			effIndex = rand.Next(0, SuitImpulseDemo.effectOptions.Length);
			eff = new HapticEffect(SuitImpulseDemo.effectOptions[effIndex], 0.0f, ((float)rand.Next(2, 10)) / 10);
		...
		public static HapticSequence VeryRandomEffect(int randSeed)
		{
			...
			for (int i = 0; i < HowManyEffects; i++)
			{
				...
				delay = ((float)rand.Next(0, 8)) / 20;
				eff = new HapticEffect(SuitImpulseDemo.effectOptions[effIndex], dur, ((float)rand.Next(0, 10)) / 10);
				seq.AddEffect(offset + delay, eff);
				offset = dur;
			}
