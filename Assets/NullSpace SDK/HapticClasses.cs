...
namespace NullSpace.SDK.Haptics
{
    ...
    public class HapticSequence
    {
        ...
        public HapticSequence(IList<HapticEffect> effects)
        {
    ...
    public class HapticEffect : IComparable, ITimeOffset
    {
        ...
        /// <param name="duration">The duration (in seconds)</param>
        /// <param name="time">The time offset (in seconds)</param>
        public HapticEffect(JEffect effect, Location location, float duration, float time)
        {
            this.effect = effect;
            this.location = location;
            this.duration = duration;
        ...
        /// <param name="location">The location</param>
        /// <param name="duration">The duration (in seconds)</param>
        public HapticEffect(JEffect effect, Location location, float duration)
        {
            this.effect = effect;
            this.location = location;
            this.duration = duration;
        ...
        public HapticEffect(JEffect effect, Location location)
        {
            this.effect = effect;
            this.location = location;
            this.duration = 0.0f;
	...
	public class HapticSample : IComparable, ITimeOffset
	{
        ...
        public float time { get; set; }
        public float originalTime;
		public IList<HapticFrame> frames;
		...
		/// <param name="priority">The priority (higher number is higher priority)</param>
		public HapticSample(float time, IList<HapticFrame> frames, int priority)
		{
			this.frames = frames;
			this.time = time;
